...
import com.ecust.projectsubmit.core.http.TestApi;
import com.ecust.projectsubmit.core.http.subscriber.NoTipRequestSubscriber;
        ...
        switch(expiredInfo.getExpiredType()) {
            case ExpiredType.KEY_TOKEN_EXPIRED:
                ...
                if (user != null) {
                    ...
                    XRouter.getInstance().build("/projectsubmit/login").navigation();
